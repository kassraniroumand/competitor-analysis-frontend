  ...
  return (
    <AppLayout>
      <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
        ...
        <PageHeader title="Competitors" subtitle="All competitors discovered across your validated ideas" />
        ...
        <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
          ...
          <Select value={ideaFilter} onValueChange={setIdeaFilter}>
            <SelectTrigger className="w-[220px] text-sm"><SelectValue placeholder="Filter by idea" /></SelectTrigger>
            <SelectContent>
          ...
          <Select value={typeFilter} onValueChange={setTypeFilter}>
            <SelectTrigger className="w-[140px] text-sm"><SelectValue placeholder="Type" /></SelectTrigger>
            <SelectContent>
            ...
            {Object.entries(groupedByIdea).map(([ideaId, competitors]) => {
              ...
              return (
                <div key={ideaId} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 pl-0 lg:pl-4">
                    {competitors.sort((a, b) => b.relevanceScore - a.relevanceScore).map((comp) => (
